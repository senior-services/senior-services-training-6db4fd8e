            ...
            <div className="flex items-center space-x-4">
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    {videoUsage?.canDelete ? quiz ? "Delete Video and Quiz" : "Delete Video" : `Cannot delete: Assigned to ${videoUsage?.assignedCount} user${videoUsage?.assignedCount !== 1 ? 's' : ''}. Use Hide on Trainings tab instead.`}
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
